...
proto.kubemq.Request.prototype.getSpan_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getSpan()));
};
/**
 * optional bytes Span = 11;
 * Note that Uint8Array is not supported on all browsers.
...
proto.kubemq.Request.prototype.getSpan_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getSpan()));
};
/** @param {!(string|Uint8Array)} value */
...
proto.kubemq.Request.prototype.getTagsMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<string,string>} */ (jspb.Message.getMapField(this, 12, opt_noLazyCreate, null));
};
...
proto.kubemq.Response.prototype.getTagsMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<string,string>} */ (jspb.Message.getMapField(this, 11, opt_noLazyCreate, null));
};
    ...
    proto.kubemq.QueueMessage.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            tagsMap: (f = msg.getTagsMap())
                ? f.toObject(includeInstance, undefined)
                : [],
            attributes: (f = msg.getAttributes()) &&
                proto.kubemq.QueueMessageAttributes.toObject(includeInstance, f),
            policy: (f = msg.getPolicy()) &&
                proto.kubemq.QueueMessagePolicy.toObject(includeInstance, f),
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.kubemq.QueueMessage.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(7, f, proto.kubemq.QueueMessageAttributes.serializeBinaryToWriter);
    }
    f = message.getPolicy();
    if (f != null) {
        writer.writeMessage(8, f, proto.kubemq.QueueMessagePolicy.serializeBinaryToWriter);
    }
};
/**
...
proto.kubemq.QueueMessage.prototype.getAttributes = function () {
    return /** @type{?proto.kubemq.QueueMessageAttributes} */ (jspb.Message.getWrapperField(this, proto.kubemq.QueueMessageAttributes, 7));
};
...
proto.kubemq.QueueMessage.prototype.getPolicy = function () {
    return /** @type{?proto.kubemq.QueueMessagePolicy} */ (jspb.Message.getWrapperField(this, proto.kubemq.QueueMessagePolicy, 8));
};
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.QueueMessagesBatchRequest.displayName =
        'proto.kubemq.QueueMessagesBatchRequest';
}
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.kubemq.QueueMessagesBatchRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            messagesList: jspb.Message.toObjectList(msg.getMessagesList(), proto.kubemq.QueueMessage.toObject, includeInstance),
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.kubemq.QueueMessagesBatchRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.kubemq.QueueMessage.serializeBinaryToWriter);
    }
};
/**
...
proto.kubemq.QueueMessagesBatchRequest.prototype.getMessagesList = function () {
    return /** @type{!Array<!proto.kubemq.QueueMessage>} */ (jspb.Message.getRepeatedWrapperField(this, proto.kubemq.QueueMessage, 2));
};
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.QueueMessagesBatchResponse.displayName =
        'proto.kubemq.QueueMessagesBatchResponse';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.kubemq.QueueMessagesBatchResponse.toObject = function (includeInstance, msg) {
        var f, obj = {
            batchid: jspb.Message.getFieldWithDefault(msg, 1, ''),
            resultsList: jspb.Message.toObjectList(msg.getResultsList(), proto.kubemq.SendQueueMessageResult.toObject, includeInstance),
...
proto.kubemq.QueueMessagesBatchResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.kubemq.SendQueueMessageResult.serializeBinaryToWriter);
    }
...
proto.kubemq.QueueMessagesBatchResponse.prototype.getResultsList = function () {
    return /** @type{!Array<!proto.kubemq.SendQueueMessageResult>} */ (jspb.Message.getRepeatedWrapperField(this, proto.kubemq.SendQueueMessageResult, 2));
};
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.QueueMessageAttributes.displayName =
        'proto.kubemq.QueueMessageAttributes';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.QueueMessagePolicy.displayName =
        'proto.kubemq.QueueMessagePolicy';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.SendQueueMessageResult.displayName =
        'proto.kubemq.SendQueueMessageResult';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.ReceiveQueueMessagesRequest.displayName =
        'proto.kubemq.ReceiveQueueMessagesRequest';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.ReceiveQueueMessagesResponse.displayName =
        'proto.kubemq.ReceiveQueueMessagesResponse';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.AckAllQueueMessagesRequest.displayName =
        'proto.kubemq.AckAllQueueMessagesRequest';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.AckAllQueueMessagesResponse.displayName =
        'proto.kubemq.AckAllQueueMessagesResponse';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.StreamQueueMessagesRequest.displayName =
        'proto.kubemq.StreamQueueMessagesRequest';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
    ...
    proto.kubemq.StreamQueueMessagesRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            modifiedmessage: (f = msg.getModifiedmessage()) &&
                proto.kubemq.QueueMessage.toObject(includeInstance, f),
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.kubemq.StreamQueueMessagesRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(8, f, proto.kubemq.QueueMessage.serializeBinaryToWriter);
    }
};
/**
 * optional string RequestID = 1;
...
proto.kubemq.StreamQueueMessagesRequest.prototype.getModifiedmessage = function () {
    return /** @type{?proto.kubemq.QueueMessage} */ (jspb.Message.getWrapperField(this, proto.kubemq.QueueMessage, 8));
};
...
if (goog.DEBUG && !COMPILED) {
    proto.kubemq.StreamQueueMessagesResponse.displayName =
        'proto.kubemq.StreamQueueMessagesResponse';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
proto.kubemq.StreamQueueMessagesResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.kubemq.QueueMessage.serializeBinaryToWriter);
    }
    f = message.getIserror();
    if (f) {
...
proto.kubemq.StreamQueueMessagesResponse.prototype.getMessage = function () {
    return /** @type{?proto.kubemq.QueueMessage} */ (jspb.Message.getWrapperField(this, proto.kubemq.QueueMessage, 3));
};
/** @param {?proto.kubemq.QueueMessage|undefined} value */
...
//# sourceMappingURL=kubemq_pb.js.map